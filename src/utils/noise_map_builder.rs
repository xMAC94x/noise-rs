...
use crate::{math::interpolate, noise_fns::NoiseFn, utils::noise_map::NoiseMap, NoiseFieldFn};
...
impl<'a> NoiseMapBuilder<'a, NoiseField2D> for PlaneMapBuilder<'a> {
    ...
    fn build(&self) -> NoiseMap {
        ...
        let grid_size = noisefield.grid_size();

        for x in 0..grid_size.0 {
            for y in 0..grid_size.1 {
                result_map.set_value(x, y, noisefield.value_at_point([x, y]));
            }
        }
